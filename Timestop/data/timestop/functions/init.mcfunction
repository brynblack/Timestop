tellraw @a[sort=arbitrary] ["",{"text":"Thank you for installing the Time Stop Datapack for 1.15! This Datapack was made by brynblack.","bold":true,"color":"dark_purple"},{"text":"\n"}]
