...
# Information
tellraw @a[sort=arbitrary] ["",{"text":"Timestop v2.0.0 - 1.15x | Please read the wiki for further information.","color":"dark_purple"},{"text":"\n"}]
tellraw @a[sort=arbitrary] ["",{"text":"-----------------------------------------------------","strikethrough":true,"color":"gold"},{"text":"\n"}]
tellraw @a[sort=arbitrary] ["",{"text":"The pack version is currently v2.0.0-beta. Please remember to post bugs onto my issue tracker if you find any.","color":"red"}]
